...
public class CANErrorMessage extends CANMessage {
    ...
    public static enum ERROR_CATEGORY {
        ...
        Lost_Arbitration(0x2,"Lost Arbitration"), // bit location
    ...
    private List<String> decode() {
        ...
        // Protocol_Violation data[2] data[3]
